    ...
    <div className="page-shell space-y-6 sm:space-y-8 animate-in fade-in duration-700 pb-16">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
        ...
        <div className="w-full lg:flex-1 space-y-8 sm:space-y-10 min-w-0">
          ...
          {/* ── Profile card shown only on mobile (between enrollment & marketplace) ── */}
        ...
        <div className="hidden lg:flex flex-col gap-8 w-full lg:w-80 xl:w-96 shrink-0">
          <ProfileCard />
          <TimelineCard />
        </div>
      </div>

      {/* Timeline shown on mobile only at the bottom */}
      <div className="lg:hidden">
        <TimelineCard />
      </div>
    </div>
...
function ProfileCard() {
  ...
  return (
    <MotionDiv
      whileHover={{ y: -4 }}
      className="bg-slate-900 rounded-[2rem] p-6 sm:p-8 text-white relative overflow-hidden"
    >
