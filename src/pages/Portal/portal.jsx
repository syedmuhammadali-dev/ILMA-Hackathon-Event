    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">Manage your academic records and enrolled courses.</p>
        </div>
      ...
      <MDBRow className="g-6">
                ...
                <MDBTable hover borderless align="middle" className="mb-0">
                  <MDBTableHead className="bg-slate-50 border-b border-slate-100">
                    <tr className="text-left">
                      <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Course Name</th>
        ...
        <MDBCol lg="4">
          <div className="space-y-6">
            {/* GPA Card */}
            <MDBCard className="border-0 shadow-sm bg-gradient-to-br from-indigo-600 to-blue-700 text-white overflow-hidden relative group">
              <div className="absolute -right-4 -top-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <MDBIcon fas icon="star" size="10x" />
              </div>
              <MDBCardBody className="p-8 relative">
                <p className="text-sm font-bold uppercase tracking-widest opacity-75 mb-3">Overall GPA</p>
                <div className="flex items-baseline gap-2">
                  <h4 className="text-5xl font-extrabold tracking-tighter">3.85</h4>
            ...
            <MDBCard className="border-0 shadow-sm">
              <MDBCardBody className="p-6">
                <h3 className="font-bold text-slate-800 mb-6 flex items-center gap-2">
                  <MDBIcon fas icon="graduation-cap" className="text-emerald-500" />
                  Academic Calendar
                </h3>
