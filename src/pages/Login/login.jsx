  ...
  const handleSubmit = async (e) => {
    ...
    if (user) {
      Swal.fire({
        icon: "success",
        title:
          getTranslation("login_welcome_prefix") +
          user.fullName +
          getTranslation("login_welcome_suffix"),
      ...
      Swal.fire({
        icon: "error",
        title: getTranslation("login_failed_title"),
        text: getTranslation("login_failed_text"),
    ...
    <div className="auth-page relative flex items-center justify-center p-6 overflow-hidden">
      ...
      >
        <div className="auth-glass-card rounded-3xl overflow-hidden flex min-h-[580px]">
          {/* ── Left panel ── */}
          <div
            className="hidden lg:flex w-[44%] flex-col justify-between relative p-12 overflow-hidden"
            style={{
              background:
                "linear-gradient(155deg, rgba(99,102,241,0.18) 0%, rgba(6,182,212,0.10) 100%)",
            }}
          >
            {/* top glow line */}
            ...
            <div className="relative z-10 mb-8">
              ...
              <h2 className="text-3xl font-black text-white-force leading-tight mb-3">
                ...
                <span style={{ color: "#06b6d4" }}>
                  {getTranslation("auth_student_portal")}
                </span>
              </h2>
              <p
            ...
            <div className="space-y-3 z-10 relative">
              {[
                  ...
                  icon: (
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M14.752 11.168l-3.197-2.132A4 4 0 0010 10v4a4 4 0 001.555 3.164l3.197 2.132a4 4 0 004.496 0l3.197-2.132A4 4 0 0024 14v-4a4 4 0 00-1.555-3.164l-3.197-2.132zM12 14l-9-5 9-5 9 5-9 5z"
                      />
                    </svg>
                  ),
                  label: getTranslation("auth_stat_students"),
                },
                {
                  icon: (
                    <svg
                  ...
                  label: getTranslation("auth_stat_faculty"),
                },
                {
                  icon: (
                    <svg
                  ...
                  label: getTranslation("auth_stat_ranked"),
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="p-2 bg-white/[0.05] rounded-lg shadow-inner">
                    {item.icon}
                  </div>
                  <span className="text-sm font-semibold text-white-force">
                    {item.label}
                  </span>
                </motion.div>
              ))}
          ...
          <div className="flex-1 flex flex-col justify-center p-6 xs:p-8 md:p-12">
            <div className="max-w-sm mx-auto w-full">
              ...
              >
                {/* mobile logo */}
                <div
                  className="w-12 h-12 xs:w-14 xs:h-14 rounded-2xl flex items-center justify-center mb-4 xs:mb-6 lg:hidden border border-white/10 overflow-hidden"
                ...
                <h1 className="text-2xl xs:text-3xl font-black text-white-force tracking-tight mb-1 xs:mb-1.5">
                  {getTranslation("auth_login_heading")}
                </h1>
                <p
              ...
              >
                ...
                <div>
                  <label className="auth-label">
                    {getTranslation("auth_email_label")}
                  </label>
                  <input
                    id="login-email"
                    type="email"
                ...
                <div>
                  <div className="flex items-center justify-between mb-[6px]">
                    <label className="auth-label" style={{ marginBottom: 0 }}>
                      {getTranslation("auth_password_label")}
                    </label>
                    <Link
                      to="/forgot-password"
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      style={{
                        color: showPw ? "#06b6d4" : "rgba(148,163,184,0.6)",
                      }}
